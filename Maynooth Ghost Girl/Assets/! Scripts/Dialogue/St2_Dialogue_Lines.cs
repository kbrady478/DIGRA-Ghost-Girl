...
public class St2_Dialogue_Lines : MonoBehaviour, IInteractable, IDialogue_Interaction
{
    ...
    [SerializeField] private AudioSource st2_Audio;
    ...
    public void Start_Interaction()
    {
        ...
        interaction_Manager.Start_Interaction(dialogue_To_Send, st2_Audio);
        interaction_Manager.in_Dialogue = true;
        interaction_Manager.StartCoroutine("St2_Facial_Interaction");
    }
